...
//                        Toast.LENGTH_SHORT).show();
    ...
    public void onBindViewHolder(PlaceViewHolder mPredictionHolder, final int i) {
        ...
        mPredictionHolder.primaryText.setText(mResultList.get(i).primery);
    ...
    public class PlaceViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mAddress,primaryText;
    ...
    public class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId,CharSequence primary, CharSequence description) {
            this.placeId = placeId;
            this.primery = primary;
