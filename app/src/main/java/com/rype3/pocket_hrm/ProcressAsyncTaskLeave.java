...
public class ProcressAsyncTaskLeave extends AsyncTask<Void, Void, String> {
    ...
    public ProcressAsyncTaskLeave(Context context) {
        this.context = context;
    }

    public ProcressAsyncTaskLeave(Activity activity,
                                  String url,
                                  String email,
                                  String pin,
                                  String epf,
...
//        }
    ...
    protected void onPostExecute(final String result) {
        ...
        switch (this.type) {
            ...
            case 1:
                ((SummaryActivity) activity).parseJsonResponse(result);
                break;
        }
    }
