...
public class FromDateActivity extends Activity  {
    ...
    //    programmaticallyExitMessage.ProgrammaticallyExitMessage(FromDateActivity.this,context,0,utils.getSharedPreference(context,Constants.LANGUAGE_TYPE));
...
//                }
    ...
    public void widget(){
        ...
        tv_from = (TextView) findViewById(R.id.textFrom);
        ...
        switch (utils.getSharedPreference(context,Constants.LANGUAGE_TYPE)){
            case "s":
                ...
                tv_from.setText(getString(R.string.s_from));
            ...
            case "t":
                ...
                tv_from.setText(getString(R.string.t_from));
            ...
            case "e":
                ...
                tv_from.setText(getString(R.string.e_from));
        ...
        public void onClick(View v) {
            if (v == btn_next){
                if (playSound(1)) {
                    if (validation()) {
                        activityAction = 1;
                        intent = new Intent(FromDateActivity.this, ToDateActivity.class);
            ...
            if (v == btn_back){
                if (playSound(1)) {
                    activityAction = 1;
                    intent = new Intent(FromDateActivity.this, ApplicationActivity.class);
                    intent.putExtra("json" ,jsonResult);
                    startActivity(intent);
                    finish();
                }
            ...
            if (v == btn_exit){
                if (playSound(1)) {
                    activityAction = 1;
                    intent = new Intent(FromDateActivity.this, LanguageActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
            ...
            switch (position){
                case 0:
                    ...
                    if (mediaPlayer.isPlaying()) {
                        mediaPlayer.stop();
                        mediaPlayer.reset();
                        mediaPlayer = MediaPlayer.create(FromDateActivity.this, R.raw.click);
                    } mediaPlayer.start();
                    break;
                ...
                case 1:
                    ...
                    if (mediaPlayer_1.isPlaying()) {
                        mediaPlayer_1.stop();
                        mediaPlayer_1.reset();
                        mediaPlayer_1 = MediaPlayer.create(FromDateActivity.this, R.raw.click_2);
                    } mediaPlayer_1.start();
                    break;
                ...
                case 2:
                    if (mediaPlayer_2.isPlaying()) {
                        mediaPlayer_2.stop();
                        mediaPlayer_2.reset();
                        mediaPlayer_2 = MediaPlayer.create(FromDateActivity.this, R.raw.error);
                    } mediaPlayer_2.start();
                    break;
            }
    ...
    public boolean validation(){
        ...
        int date = Integer.parseInt(fromDate[0]);
        ...
        selectedTimestamp = calendarFrom.getTimeInMillis()/1000;
    ...
    public void getDayofweek(int date){
        ...
        from_date = String.valueOf(date+1) +"/"+ String.valueOf(month%12+1 )+"/"+String.valueOf(year+getYearPosition);
    }
    ...
    private void exitAlertMessageBox() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(FromDateActivity.this)
                .setTitle("ERROR")
                .setMessage("PRESS OK")
