...
public class HalfDayActivity extends Activity {
   ...
   //     programmaticallyExitMessage.ProgrammaticallyExitMessage(HalfDayActivity.this,context,0,utils.getSharedPreference(context,Constants.LANGUAGE_TYPE));
...
//
//                Calendar calendar = new GregorianCalendar(year,(month), dayOfMonth); // Note that Month value is 0-based. e.g., 0 for January.
...
//        });
    ...
    private void exitAlertMessageBox() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(HalfDayActivity.this)
                .setTitle("ERROR")
                .setMessage("PRESS OK")
